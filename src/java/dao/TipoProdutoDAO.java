...
public class TipoProdutoDAO {
    ...
    public Boolean incluir(TipoProduto obj) {
        ...
        try {
            ...
            Logger.getLogger(TipoProduto.class.getName()).log(Level.SEVERE, null, e);
    ...
    public Boolean alterar(TipoProduto obj) {
        ...
        try {
            ...
            Logger.getLogger(TipoProdutoDAO.class.getName()).log(Level.SEVERE, null, e);
    ...
    public List<TipoProduto> listar() {
        return em.createQuery("Select t from TipoProduto t").getResultList();
    }

    public List<TipoProduto> listar(String filtro) throws Exception {
        return em.createNamedQuery("Categoria.findFilter").setParameter("filtro", "%" + filtro.toUpperCase() + "%").getResultList();
    }

    public TipoProduto buscarPorChavePrimaria(Integer chaveprimaria) {
        return em.find(TipoProduto.class, chaveprimaria);
    }
